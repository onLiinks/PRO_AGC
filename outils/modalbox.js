...
Modalbox.Methods = {
	...
	options: {
		...
		loadingString: "<div style=\"width: 100px; margin: auto;\">Chargement...</div>", // Default loading string message
	...
	_init: function(options) {
		...
		this.MBframe.insert({'bottom':this.MBcontent});
                ...
                this.MBfooter = new Element("div", {id: "MB_footer"})
                this.MBframe.insert({'bottom':this.MBfooter});
                this.MBfooter.hide();
	...
	show: function(content, options) {
		...
		if (this.options.title) { // Updating title of the MB
			...
			this.MBfooter.update(this.options.footer);
		}
                this.MBfooter.hide();
	...
	_insertContent: function(content, callback) {
                if(this.options.infiniteLoading) {
                    this.MBframe.insert({'bottom': new Element("div", {id: "MB_content_infinite_loading"}).update(
                        this.MBLodingInfinite = new Element("div", {id: "MB_loading_infinite_loading"}).update(this.options.loadingString)
                    )});
                }
	...
	_setWidth: function() { // Set size
		...
		this.MBfooter.setStyle({width: this.options.width + "px"});
	},
	...
	event: function(eventName) {
        ...
        hideLoading: function() {
            if(this.MBcontent) {
                if(this.MBLodingInfinite) {
                    this.MBLodingInfinite.hide();
                }
                this.MBcontent.show();
                this.MBfooter.show();
            }
