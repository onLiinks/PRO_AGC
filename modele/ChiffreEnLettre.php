...
/**
  * Fichier ChiffreEnLettre.php
  *	classe chargé sur site Files.CodeS-SourceS.com 
  */

/**
  * Déclaration de la classe ChiffreEnLettre
  */
class ChiffreEnLettre
{
	...
	private $enLettre = '';
	private $chiffre  = array(1=>"un",2=>"deux",3=>"trois",4=>"quatre",5=>"cinq",6=>"six",7=>"sept",8=>"huit",9=>"neuf",
	...
	if (!empty($this->enLettre))
		return ucfirst(strtolower(trim($this->enLettre)));
	}		
