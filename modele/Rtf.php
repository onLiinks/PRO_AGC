      ...
      */
      ...
      class rtf {
            ...
            */
			...
			function decodeSC($data) {
				$data = str_replace("\'e2",'â',$data);
				$data = str_replace("\'e0",'à',$data);
				$data = str_replace("\'e3",'ã',$data);
				$data = str_replace("\'e7",'ç',$data);
				$data = str_replace("\'ea",'ê',$data);
				$data = str_replace("\'e9",'é',$data);
			    $data = str_replace("\'e8",'è',$data);				
				$data = str_replace("\'f1",'ñ',$data);
				$data = str_replace("\'f4",'ô',$data);
				$data = str_replace("\'f6",'ö',$data);
				$data = str_replace("\'f9",'ù',$data);
				$data = str_replace("\'fb",'û',$data);
				$data = str_replace("\'fc",'ü',$data);
				$data = str_replace("\'ff",'ÿ',$data);
                $data = str_replace("\'a3",'£',$data);
				$data = str_replace("\'88",'à',$data);
				$data = str_replace("\'a7",'$',$data);
				$data = str_replace("\'b2",'²',$data);
				$data = str_replace("\'a4",'¤',$data);
				$data = str_replace("\par "," ",$data);
				$data = str_replace("\ldblquote"," ",$data);
				$data = str_replace("\page"," ",$data);
				$data = str_replace("\bullet"," ",$data);
				$data = str_replace("{\'b7}"," ",$data);
				$data = preg_replace('<rtf1[\w\W]+fs16?>'," ",$data);
