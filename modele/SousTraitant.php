 ...
 */
class SousTraitant implements IRessource {
...
';
    ...
    public function getName() {
         ...
         * 
         */
        $ligne = $db->query('SELECT ARS_TYPERESSOURCE,ARS_RESSOURCE,ARS_LIBELLE,ARS_LIBELLE2,PSA_LIBELLE,PSA_PRENOM FROM RESSOURCE LEFT JOIN SALARIES ON ars_salarie=salaries.psa_salarie WHERE ARS_RESSOURCE="' . $this->Id_ressource . '"')->fetchRow();
    ...
    public static function getCegidEmployeeCode($i) {
        if ((is_numeric($i))) {
             ...
             *
             */
            return $db->query('SELECT PSA_SALARIE FROM SALARIES WHERE PSA_NUMEROSS="' . self::getSocialInsuranceNumber($i) . '"')->fetchRow()->psa_salarie;
        } else {
            $db = connecter_cegid();
            /*
    ...
    public function getAgency() {
         ...
         * 
         */
        return $db->query('SELECT PSA_ETABLISSEMENT FROM SALARIES WHERE PSA_SALARIE="' . self::getCegidEmployeeCode($this->Id_ressource) . '"')->fetchRow()->psa_etablissement;
    }
